...
let ADDRESS_OP_SEPO_WORLD_ID_ROUTER = process.env.ADDRESS_OP_SEPO_WORLD_ID_ROUTER;
...
async function main() {
  ...
  console.log("ADDRESS_OP_SEPO_WORLD_ID_ROUTER", process.env.ADDRESS_OP_SEPO_WORLD_ID_ROUTER);
  ...
  const worldVerify = await WorldVerify.deploy(ADDRESS_OP_SEPO_WORLD_ID_ROUTER, WORLDID_APP_ID, WORLDID_ACTION_ID);
  ...
  console.log('\n', "WorldVerify");
  console.log(VERIFYING_COMMAND,` ${worldVerify.target} ${ADDRESS_OP_SEPO_WORLD_ID_ROUTER} ${WORLDID_APP_ID} ${WORLDID_ACTION_ID}`);
  console.log("----------------------------------", '\n');
